...
*/
echo "My name is $firstName $lastName. Iwas born on $month $day, $year.";
$assembled = "My name is $firstName $lastName. Iwas born on $month $day, $year.";
/*
Print assembled.
*/    
...
*/
$image_src="<img src = \"var.png\" alt=\"placeholder-image\" />";
echo "$image_src <br> armchair: $295.44" ;

//I couldn't get the figcaption to work. I did research on many websites but nothing seemed to work.
?>
